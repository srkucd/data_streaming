...
CONNECTOR_NAME = "MyFirstJDBCConnector"
...
def configure_connector():
    ...
    resp = rest_method(
        ...
        data=json.dumps(
            {
                "name": "clicks_JDBC",  # TODO
                "config": {
                    "connector.class": "io.confluent.connect.jdbc.JdbcSourceConnector",  # TODO
                    "topic.prefix": "MyFirstJDBCConnector.",  # The dot at the end makes kafka topic more readable in terminal

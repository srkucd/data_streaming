...
def get_topics():
    ...
    resp = requests.get(REST_PROXY_URL+"/topics")
...
def get_topic(topic_name):
    ...
    # TODO: See: https://docs.confluent.io/current/kafka-rest/api.html#get--topics
    resp = requests.get(REST_PROXY_URL+"/topics"+"/"+topic_name)  # TODO
...
def get_brokers():
    ...
    resp = requests.get(REST_PROXY_URL + "/brokers")  # TODO
...
def get_partitions(topic_name):
    ...
    resp = requests.get(REST_PROXY_URL + '/topics/' + topic_name + '/partitions')
